...
<section id="hero" class="relative mx-auto mt-32 max-w-7xl px-6 text-center md:px-8">
	...
	>
		<div
			class="rounded-xl border border-white/10 bg-[#ffebee] bg-opacity-[0.01] before:absolute before:bottom-1/2 before:left-0 before:top-0 before:size-full before:opacity-0 before:[background-image:linear-gradient(to_bottom,#ffccbc,#ffccbc,transparent_40%)] before:[filter:blur(180px)] {inView
